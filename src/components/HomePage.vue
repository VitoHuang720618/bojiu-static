...
import { recommendedRoutes, siteConfig, titles } from '../config/siteConfig';
...
const nextSlide = () => {
    currentSlide.value =
        (currentSlide.value + 1) % effectiveCarouselSlides.value.length;
};

const prevSlide = () => {
    currentSlide.value =
        (currentSlide.value - 1 + effectiveCarouselSlides.value.length) %
        effectiveCarouselSlides.value.length;
};
...
<template>
    <div class="main-inner">
        ...
        <div
            id="banner"
            :class="{ 'banner-empty': !effectiveBanner }"
        >
            <ImageComponent
            ...
            <div
                v-else
                class="banner-placeholder-visual"
            >
        ...
        <div
            ...
            :style="{
                ...
                backgroundSize: effectiveBackgroundImage
                    ? 'auto'
                    : '16px 16px, 32px 32px, 100% 60px, 100% 60px',
                backgroundPosition: effectiveBackgroundImage
                    ? 'top left'
                    : '0 0, 8px 8px, top, bottom',
                backgroundRepeat: effectiveBackgroundImage
                    ? 'repeat'
                    : 'repeat, repeat, repeat-x, repeat-x'
            }"
        >
            <div class="home-main__inner">
                ...
                <div class="button-links">
                    ...
                    >
                        <template
                            v-if="
                                effectiveButtonLinks[index]?.defaultImage !==
                                undefined
                            "
                        >
                            <ImageButton
                                ...
                                "
                                :hover-src="
                                    effectiveButtonLinks[index]?.hoverImage ||
                                    ''
                                "
                                :alt="item.alt"
                ...
                <div class="recommend-section">
                    ...
                    <div class="recommend-content">
                        ...
                        <div class="recommend-links">
                            ...
                            <div class="links">
                                <div
                                    v-for="(item, index) in effectiveRouteLinks"
                                    :key="index"
                                    class="item"
                                >
                                    <ImageButton
                                        ...
                                        :alt="recommendedRoutes[index]?.title"
                                        :href="item.href"
                                        :lazy="false"
                                        target="_blank"
                                    />
                    ...
                    <div class="recommend-footer">
                        ...
                        <div class="tools">
                            <div
                                v-for="tool in effectiveToolIcons"
                                :key="tool.id"
                                class="item"
                            >
                                <ImageButton
                                    :default-src="tool.default"
                                    :hover-src="tool.hover"
                                    :alt="tool.alt"
                                    :href="tool.href"
                                    target="_blank"
                                />
                ...
                <div class="programme-wrap">
                    ...
                    <div class="programme-block">
                        <div class="block-title">
                            <ImageComponent
                                :src="
                                    siteConfig.useApi && titles.selectedVideos
                                        ? titles.selectedVideos
                                        : assetManifest.titles.selectedVideos
                                "
                                alt="精选短视频標題圖"
                                :lazy="false"
                            />
                    ...
                    <div class="programme-block sport-block">
                        <div class="block-title">
                            <ImageComponent
                                :src="
                                    siteConfig.useApi && titles.hotPrograms
                                        ? titles.hotPrograms
                                        : assetManifest.titles.hotPrograms
                                "
                                alt="火熱節目標題圖"
                                :lazy="false"
                            />
        ...
        <div id="float-ad">
            ...
            <div class="links">
                ...
                >
                    ...
                    <ImageButton
                        class="tablet-image"
                        :default-src="button.tablet || button.default"
                        :hover-src="button.tablet || button.default"
                        :alt="`浮動廣告 ${index + 1}`"
                        :href="button.href"
                        target="_blank"
                    />
                    ...
                    <ImageButton
                        class="mobile-image"
                        :default-src="button.mobile || button.default"
                        :hover-src="button.mobile || button.default"
                        :alt="`浮動廣告 ${index + 1}`"
                        :href="button.href"
                        target="_blank"
                    />
...
@media (max-width: 430px) {
    ...
    .recommend-routes-title .title-text {
        ...
        font-family:
            'Microsoft YaHei UI', 'Microsoft YaHei UI-Bold', sans-serif !important;
